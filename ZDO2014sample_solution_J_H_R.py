        ...
        if self.hogFeatures:
            ...
            if size>5000:
                if 1.4>pomer<0.6:
                    ...
                    fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(8,4),
                        cells_per_block=(3,3), visualise=True, normalise=False)
                    if demo:
                        plt.imshow(imr)
                    ...
                    fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(4,8),
                        cells_per_block=(3,3), visualise=True, normalise=False)
                    if demo:
                        plt.imshow(imr)
                ...
                if 1.4>pomer<0.6:
                    ...
                    fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(4,4),
                        cells_per_block=(3,3), visualise=True, normalise=False)
                    if demo:
                        plt.imshow(imr)
                    ...
                    fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(4,2),
                        cells_per_block=(3,3), visualise=True, normalise=False)
                    if demo:
                        plt.imshow(imr)
                    ...
                    fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(2,4),
                        cells_per_block=(3,3), visualise=True, normalise=False)
                    if demo:
                        plt.imshow(imr)
...
#            imr=img
#            fd, hog_image = hog(imr, orientations=8, pixels_per_cell=(4,4),
#                    cells_per_block=(3,3), visualise=True, normalise=True)
#            if demo:
#                plt.imshow(imr)
#                plt.suptitle('Zmenseni obrazu na velikost 32x32 pixelu.')
#                plt.show() 
#                plt.imshow(hog_image)
#                plt.suptitle('Analyza obrazu algoritmem HoG, rozdeleny na 8 bloku.')
#                plt.show()        
...
# Natrenujeme na 3. sade
    zn.train(datadir='D:/ZDO/zdo2014-training3/zdo2014-training3/')
# Otestujeme na 1. sade
    zn.kontrola('D:/ZDO/zdo2014-training1/zdo2014-training1/')
